package ir.pupli.jalalicalendarlib;
...
public class JCalendar {
    ...
    public JCalendar(int year, int month, int day, boolean fromGregorian) {
        if (fromGregorian) {
     ...
     */
    public JCalendar(GregorianCalendar gc) {
        fromGregorian(gc);
    }
    ...
    private void fromJulianDay(int JulianDayNumber) {
        ...
        GregorianCalendar gregorianFirstFarvardin = new JCalendar(jalaliYear, 1, 1).getGregorianFirstFarvardin();
    ...
    public Date toGregorianDate() {
        Date date = this.toGregorian().getTime();
        return date;
    }
